        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" action="${pageContext.request.contextPath}/student/search"
                          method="post">
                        ...
                        <div class="form-group" style="margin-left: 20px">
                            <label for="studentValue">值：</label>
                            <input id="studentValue" type="text" class="form-control" name="value" placeholder="字段值"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal" role="form">
                                        <div class="form-group">
                                            <label for="addDormitory" class="col-sm-3 control-label">宿舍</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="addNumber" class="col-sm-3 control-label">学号</label>
                                            <div class="col-sm-9">
                                                <input type="text" required class="form-control" id="addNumber"
            ...
            <nav aria-label="Page navigation" style="text-align: center;">
                <ul class="pagination">
                    <li><a href="${pageContext.request.contextPath}/student/listPage?page=1&size=5" aria-label="Previous">首页</a>
                    </li>
                    <li><a href="${pageContext.request.contextPath}/student/listPage?page=${pageInfos.pageNum-1}&size=5">上一页</a>
                    </li>
                    <c:forEach begin="1" end="${pageInfos.pages}" var="pageNumber">
                        <li>
                            <a href="${pageContext.request.contextPath}/student/listPage?page=${pageNumber}&size=5">${pageNumber}</a>
                        </li>
                    </c:forEach>
                    <li><a href="${pageContext.request.contextPath}/student/listPage?page=${pageInfos.pageNum+1}&size=5">下一页</a>
                    </li>
                    <li><a href="${pageContext.request.contextPath}/student/listPage?page=${pageInfos.pages}&size=5"
...
<script>
    $('#updateUserModal').on('show.bs.modal', function (event) {
        ...
        const list2 = modal.find('.dormitory');
