        ...
        <div class="col-sm-10">
            ...
            <div class="table-responsive">
                <table class="table table-hover ">
                    ...
                    <tbody>
                    <c:forEach items="${pageInfos.list}" var="building">
                        <tr>
                            <td>${building.id}</td>
                            <td>${building.name}</td>
                ...
                <!-- 删除模态框示例（Modal） -->
                <form method="post" action="${pageContext.request.contextPath}/building/delete"
            ...
            <nav aria-label="Page navigation" style="text-align: center;">
                <ul class="pagination">
                    <li><a href="${pageContext.request.contextPath}/building/listPage.do?page=1&size=5" aria-label="Previous">首页</a>
                    </li>
                    <li><a href="${pageContext.request.contextPath}/building/listPage.do?page=${pageInfos.pageNum-1}&size=5">上一页</a>
                    </li>
                    <c:forEach begin="1" end="${pageInfos.pages}" var="pageNumber">
                        <li>
                            <a href="${pageContext.request.contextPath}/building/listPage.do?page=${pageNumber}&size=5">${pageNumber}</a>
                        </li>
                    </c:forEach>
                    <li><a href="${pageContext.request.contextPath}/building/listPage.do?page=${pageInfos.pageNum+1}&size=5">下一页</a>
                    </li>
                    <li><a href="${pageContext.request.contextPath}/building/listPage.do?page=${pageInfos.pages}&size=5"
...
<script>
    $('#updateUserModal').on('show.bs.modal', function(event) {
        ...
        const introduction = button.data('introduction');
        const modal = $(this);
