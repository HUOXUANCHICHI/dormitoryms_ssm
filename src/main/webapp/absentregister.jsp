...
<div class="container-fluid">
    <form method="post" action="${pageContext.request.contextPath}/absent/save" class="form-horizontal" style="margin-top: 0px" role="form"
...
<script>
    $(function(){
        $('#building').change(function(){
            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    let str = '';
                    for(let i = 0; i<dormitoryList.length; i++){
        ...
        $('#dormitory').change(function(){
            const id = $(this).val();
            $.ajax({
                url:"${pageContext.request.contextPath}/student/findByDormitoryId?dormitoryId="+id,
                type:"post",
                contentType:"application/json;charset=UTF-8",
                dataType:"text",
                success:function (data) {
