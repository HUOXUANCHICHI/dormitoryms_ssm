        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" action="${pageContext.request.contextPath}/dormitory/search" method="post">
            ...
            <div class="table-responsive">
                ...
                <!-- add框示例（Modal） -->
                <form method="post" action="${pageContext.request.contextPath}/dormitory/save" class="form-horizontal" style="margin-top: 0px" role="form"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="addMyModalLabel">添加宿舍信息</h4>
                                </div>
                                <div class="modal-body">
                                    <form class="form-horizontal" role="form">
                                        <div class="form-group">
                                            <label for="buildingName" class="col-sm-3 control-label">楼宇</label>
                                            <div class="col-sm-9">
                                                <select id="buildingName" class="form-control" name="buildingId">
                                        ...
                                        <div class="form-group">
                                            <label for="dormitoryName" class="col-sm-3 control-label">名称</label>
                                            <div class="col-sm-9">
                                                <input type="text" required class="form-control" id="dormitoryName"
                ...
                <!-- update框示例（Modal） -->
                <form method="post" action="${pageContext.request.contextPath}/dormitory/update" class="form-horizontal" style="margin-top: 0px" role="form"
                ...
                <!-- 删除模态框示例（Modal） -->
                <form method="post" action="${pageContext.request.contextPath}/dormitory/delete"
            ...
            <nav aria-label="Page navigation" style="text-align: center;">
                <ul class="pagination">
                    <li><a href="${pageContext.request.contextPath}/dormitory/listPage?page=1&size=5" aria-label="Previous">首页</a>
                    </li>
                    <li><a href="${pageContext.request.contextPath}/dormitory/listPage?page=${pageInfos.pageNum-1}&size=5">上一页</a>
                    </li>
                    <c:forEach begin="1" end="${pageInfos.pages}" var="pageNumber">
                        <li>
                            <a href="${pageContext.request.contextPath}/dormitory/listPage?page=${pageNumber}&size=5">${pageNumber}</a>
                        </li>
                    </c:forEach>
                    <li><a href="${pageContext.request.contextPath}/dormitory/listPage?page=${pageInfos.pageNum+1}&size=5">下一页</a>
                    </li>
                    <li><a href="${pageContext.request.contextPath}/dormitory/listPage?page=${pageInfos.pages}&size=5"
